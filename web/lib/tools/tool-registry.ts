...
export const TOOLS_REGISTRY: ToolDefinition[] = [
  ...
  {
    id: "hash-generator",
    name: "MD5, SHA & Base64 Hash Generator",
    shortName: "Hash Generator",
    category: "security",
    categoryLabel: "Security & Headers",
    description: "Cryptographic hashing with SHA-256, SHA-512, SHA-1, MD5 (RFC 1321), and Base64.",
    detailedDescription: "Generate cryptographic digests directly in your browser using the native Web Crypto API plus a dependency-free RFC 1321 MD5 implementation, for test data seeding and integrity checks.",
    tags: ["Hash", "SHA-256", "SHA-512", "SHA-1", "MD5", "Base64", "Checksum", "Security"],
    icon: "Fingerprint",
